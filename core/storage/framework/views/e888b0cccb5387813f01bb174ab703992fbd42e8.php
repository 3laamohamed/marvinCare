            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Add Blog Category')); ?></h3>
                                <div class="card-tools">
                                    <a href="<?php echo e(route('admin.blog'). '?language=' . $currentLang->code); ?>" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.blog.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                                <textarea name="content" class="form-control summernote" id="ck" rows="6" placeholder="<?php echo e(__('Content')); ?>"><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/blog/add.blade.php ENDPATH**/ ?>