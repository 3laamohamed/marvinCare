            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Add Slider')); ?></h3>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.slider.store')); ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <p class="help-block text-info"><?php echo e(__('Upload 1920X460 (Pixel) Size image or Squre size image for best quality.
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="offer" placeholder="<?php echo e(__('Offer')); ?>" value="<?php echo e(old('offer')); ?>">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="desc" class="form-control" placeholder="<?php echo e(__('Description')); ?>" rows="7"><?php echo e(old('desc')); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/slider/add.blade.php ENDPATH**/ ?>