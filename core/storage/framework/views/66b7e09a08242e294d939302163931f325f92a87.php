                        ...
                        <div class="card-body table-responsive">
                            <form  action="<?php echo e(route('admin.language.update', $language->id)); ?>" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="code" placeholder="<?php echo e(__('Enter code')); ?>" value="<?php echo e($language->code); ?>">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/language/edit-languages.blade.php ENDPATH**/ ?>