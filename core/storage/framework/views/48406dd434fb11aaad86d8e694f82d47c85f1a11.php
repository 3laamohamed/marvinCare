	...
	<div class="site-container">
		...
		<div class="row dark-gray footer-row full-width padding-top-61 padding-bottom-36" id="contactId">
			<div style="padding: 0px 15px;">
				<h2 style="color:white" class="box-header"><?php echo e($sectionInfo->contact_title); ?></h2>
				<p class="description align-center"><?php echo e($setting->footer_text); ?></p>
			</div>
			<div class="row row-4-4">
				<div class="cards-p4">
					<div class="contact-minicards">
						<div class="contact-forms">
							<form method="POST" action="<?php echo e(route('front.storeContact')); ?>">
								<?php echo csrf_field(); ?>
								<div class="middle">
							...
							<div class="row">
								<ul class="contact-data margin-top-20">
									<li class="template-location">
										<div class="value"><?php echo e($setting->address); ?></div>
									</li>
									<?php
										$phoneArray = explode(",",$setting->number)
									?>
									<?php for($i = 0; $i<sizeof($phoneArray) ; $i++): ?>
										<li class="template-mobile">
											<div class="value"><a href="tel:<?php echo e($phoneArray[$i]); ?>"><?php echo e($phoneArray[$i]); ?></a></div>
										</li>
									<?php endfor; ?>
									<li class="template-email">
										<div class="value"><a href="mailto:<?php echo e($setting->email); ?>"><?php echo e($setting->email); ?></a></div>
									</li>
								</ul>
								<ul class="social-icons align-center margin-top-20">
									<?php $__currentLoopData = $social; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $so): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<li>
											<a target="_blank" href="<?php echo e($so->url); ?>" class="<?php echo e($so->icon); ?>" title="twitter"></a>
										</li>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</ul>
							</div>
			...
			<div class="row align-center padding-top-30">
				<span class="copyright"><?php echo $setting->copyright_text; ?></span>
			</div>
		</div>
	</div>
...
</html><?php /**PATH C:\xampp\htdocs\marvin\core\resources\views/front/new_layout.blade.php ENDPATH**/ ?>