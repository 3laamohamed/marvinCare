<nav class="main-header navbar navbar-expand navbar-light navbar-white">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link pt-0 pr-3 " data-toggle="dropdown" href="#">
            <img class="user-image w-40 img-circle shadow" src="<?php echo e(asset('assets/front/img/'.$adminprofile->image)); ?>"  alt="User Image">
        </a>
              ...
              <div class="card card-widget widget-user-2 mb-0 shadow-none">
                ...
                <div class="widget-user-header bg-primary">
                  <div class="widget-user-image bg-white">
                    <img class="img-circle elevation-2  bg-white" src="<?php echo e(asset('assets/front/img/'.$adminprofile->image)); ?>" alt="User Avatar">
                  </div>
                  <!-- /.widget-user-image -->
                  <h6 class="widget-user-username mt-2"><?php echo e($adminprofile->name); ?></h6>
                  <h6 class="widget-user-desc"><?php echo e($adminprofile->email); ?></h6>
                </div>
  ...
  </nav><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/partials/top-navbar.blade.php ENDPATH**/ ?>