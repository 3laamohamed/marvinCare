                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="<?php echo e(route('admin.testimonialcontent.update',  $saectiontitle->language_id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 control-label"><?php echo e(__('Testimonial BG Image')); ?> </label>
                                <div class="col-sm-10">
                                    <img class="mw-400 mb-3 show-img img-demo" src="
                                    <?php if($saectiontitle->testimonial_bg): ?>
                                    <?php echo e(asset('assets/front/img/'.$saectiontitle->testimonial_bg)); ?>
                ...
                <div class="card card-primary card-outline">
                    ...
                    <table class="table table-striped table-bordered data_table">
                        ...
                        <tr>
                            ...
                            <td width="40%"><?php echo e($testimonial->message); ?></td>
                            <td width="18%">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/testimonial/index.blade.php ENDPATH**/ ?>