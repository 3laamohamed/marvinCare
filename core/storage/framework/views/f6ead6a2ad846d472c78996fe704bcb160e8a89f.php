      ...
      <div class="col-lg-12">
        <div class="card card-primary card-outline">
          <div class="card-header">
            <h3 class="card-title mt-1"><?php echo e(__('Add Why Us')); ?></h3>
          ...
          <!-- /.card-header -->
          <div class="card-body">
            <form class="form-horizontal" action="<?php echo e(route('admin.why_us.store')); ?>" method="POST"
              ...
              <div class="form-group row">
                <label class="col-sm-2 control-label"><?php echo e(__('Icon')); ?></label>
                <div class="col-sm-10">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea name="disc" class="form-control summernote" rows="3"
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/whyus/add.blade.php ENDPATH**/ ?>