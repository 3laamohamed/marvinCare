                    ...
                    <div class="card-body">
                        <form class="form-horizontal" action="<?php echo e(route('admin.footer.update', $footerinfo->language_id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" class="form-control summernote" name="copyright_text" placeholder="Copyright © 2023. All Rights Reserved By Abdelrahman Mohamed">Copyright © 2023. All Rights Reserved By Abdelrahman Mohamed</textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/footer/index.blade.php ENDPATH**/ ?>