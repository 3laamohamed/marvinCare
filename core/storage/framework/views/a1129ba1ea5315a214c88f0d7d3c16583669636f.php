            ...
            <div class="col-md-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h3 class="card-title mt-1"><?php echo e(__('Dynamic Page List')); ?></h3>
                        <div class="card-tools d-flex">
                            ...
                            <a href="<?php echo e(route('admin.dynamic_page.add'). '?language=' . $currentLang->code); ?>" class="btn btn-primary btn-sm">
                    ...
                    <table class="table table-striped table-bordered data_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.dynamic_page.edit', $dynamicpage->id)); ?>" class="btn btn-info btn-sm"><i class="fas fa-pencil-alt"></i><?php echo e(__('Edit')); ?></a>
                                    <form  id="deleteform" class="d-inline-block" action="<?php echo e(route('admin.dynamic_page.delete', $dynamicpage->id )); ?>" method="post">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvin\core\resources\views/admin/dynamicpage/index.blade.php ENDPATH**/ ?>