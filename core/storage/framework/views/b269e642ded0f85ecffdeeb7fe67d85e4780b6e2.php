...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark"><?php echo e(__('Project')); ?> </h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="<?php echo e(route('admin.project'). '?language=' . $currentLang->code); ?>" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.project.update',  $service->id)); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <img class="mw-400 mb-3 show-img img-demo" src="<?php echo e(asset('assets/front/img/'.$service->image)); ?>" alt="">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label"><?php echo e(__('Project Name')); ?><span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="content" class="form-control summernote" placeholder="<?php echo e(__('Description')); ?>" rows="7"><?php echo e($service->content); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/projects/edit.blade.php ENDPATH**/ ?>