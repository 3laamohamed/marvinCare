            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1"><?php echo e(__('Edit Work Category')); ?></h3>
                                <div class="card-tools">
                                    <a href="<?php echo e(route('admin.workcategory'). '?language=' . $currentLang->code); ?>" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="<?php echo e(route('admin.workcategory.update', $bcategory->id)); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control lang" name="language_id">
                                                <?php $__currentLoopData = $langs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($lang->id); ?>" <?php echo e($bcategory->language_id == $lang->id ? 'selected' : ''); ?> ><?php echo e($lang->name); ?></option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/work/work-category/edit.blade.php ENDPATH**/ ?>