                        ...
                        <form class="form-horizontal" action="<?php echo e(route('admin.setting.commoninfo')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php echo e(asset('assets/front/img/'.$commoninfo->fav_icon)); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php echo e(asset('assets/front/img/'.$commoninfo->header_logo)); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/settings/basicinfo.blade.php ENDPATH**/ ?>