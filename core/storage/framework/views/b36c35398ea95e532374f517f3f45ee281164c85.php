...
<aside class="main-sidebar elevation-4 main-sidebar elevation-4 sidebar-light-primary">
        ...
        <?php endif; ?>">
          ...
          <?php endif; ?>">
            ...
            <?php endif; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.contact'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/contact'): ?> active
            <?php endif; ?>">
                        <i class="nav-icon fas fa-user"></i>
                        <p>
                            Contacts
            ...
            <?php endif; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.project'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/project'): ?> active
            <?php elseif(request()->path() == 'admin/project/add'): ?> active
            <?php elseif(request()->is('admin/project/edit/*')): ?> active
            <?php endif; ?>">
                        <i class="nav-icon fas fa-briefcase"></i>
                        <p>
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.why_us'). '?language=' . $lang_code); ?>" class="nav-link
            <?php if(request()->path() == 'admin/why_us'): ?> active
            <?php elseif(request()->path() == 'admin/why_us/add'): ?> active
            <?php elseif(request()->is('admin/why_us/edit/*')): ?> active
            <?php endif; ?>">
                        <i class="nav-icon fas fa-briefcase"></i>
                        <p>
                            <?php echo e(__('Why Us')); ?>
            ...
            <?php endif; ?>">
              ...
              <?php endif; ?>">
                ...
                <li class="nav-item has-treeview
              <?php if(request()->path() == 'admin/work'): ?> menu-open
              <?php elseif(request()->path() == 'admin/work/work-category'): ?> menu-open
              <?php elseif(request()->path() == 'admin/work/work-category/add'): ?> menu-open
              <?php elseif(request()->path() == 'admin/work/add'): ?> menu-open
              <?php elseif(request()->path() == 'admin/archives'): ?> menu-open
              <?php elseif(request()->path() == 'admin/archive/edit'): ?> menu-open
              <?php elseif(request()->path() == 'admin/archive/add'): ?> menu-open
              <?php elseif(request()->is('admin/work/work-category/edit/*')): ?> menu-open
              <?php elseif(request()->is('admin/work/edit/*')): ?> menu-open
              <?php endif; ?>">
                    <a href="#" class="nav-link
                <?php if(request()->path() == 'admin/work'): ?> active
                <?php elseif(request()->path() == 'admin/work/work-category'): ?> active
                <?php elseif(request()->path() == 'admin/work/work-category/add'): ?> active
                <?php elseif(request()->path() == 'admin/work/add'): ?> active
                <?php elseif(request()->path() == 'admin/archives'): ?> active
                <?php elseif(request()->path() == 'admin/archive/edit'): ?> active
                <?php elseif(request()->path() == 'admin/archive/add'): ?> active
                <?php elseif(request()->is('admin/work/work-category/edit/*')): ?> active
                <?php elseif(request()->is('admin/work/edit/*')): ?> active
                <?php endif; ?>">
                        <i class="nav-icon fas fa-box-open"></i>
                        <p>
                            <?php echo e(__('Work')); ?>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.workcategory'). '?language=' . $lang_code); ?>" class="nav-link
                  <?php if(request()->path() == 'admin/work/work-category'): ?> active
                  <?php elseif(request()->path() == 'admin/work/work-category/add'): ?> active
                  <?php elseif(request()->is('admin/work/work-category/edit/*')): ?> active
                  <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Work Categories')); ?></p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('admin.work'). '?language=' . $lang_code); ?>" class="nav-link
                  <?php if(request()->path() == 'admin/work'): ?> active
                  <?php elseif(request()->path() == 'admin/work/add'): ?> active
                  <?php elseif(request()->is('admin/work/edit/*')): ?> active
                  <?php endif; ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p><?php echo e(__('Work')); ?></p>
                            </a>
                        </li>
                    </ul>
                </li>
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/partials/side-navbar.blade.php ENDPATH**/ ?>