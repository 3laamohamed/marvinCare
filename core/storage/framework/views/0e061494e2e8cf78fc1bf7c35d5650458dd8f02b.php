                        ...
                        <form class="form-horizontal" action="<?php echo e(route('admin.aboutcontent.update',  $saectiontitle->language_id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <?php echo e(asset('assets/front/img/'.$saectiontitle->about_image)); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\marvinCare\core\resources\views/admin/about/index.blade.php ENDPATH**/ ?>