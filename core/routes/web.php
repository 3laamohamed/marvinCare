...
Route::group(['middleware' => 'setlang'], function () {
    ...
    Route::get('/project', 'Front\FrontendController@project')->name('front.project');
    ...
    Route::get('/work', 'Front\FrontendController@work')->name('front.work');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth:admin']], function () {
    ...
    // project Route
    Route::get('/project', 'Admin\ProjectController@service')->name('admin.project');
    Route::get('/project/add', 'Admin\ProjectController@add')->name('admin.project.add');
    Route::post('/project/store', 'Admin\ProjectController@store')->name('admin.project.store');
    Route::post('/project/delete/{id}/', 'Admin\ProjectController@delete')->name('admin.project.delete');
    ...
    Route::post('/project/servicecontent/{id}/', 'Admin\ProjectController@projectcontent')->name('admin.projectcontent.update');


    // Why Us Route
    Route::get('/why_us', 'Admin\WhyUsController@why_us')->name('admin.why_us');
    Route::get('/why_us/add', 'Admin\WhyUsController@add')->name('admin.why_us.add');
    Route::post('/why_us/store', 'Admin\WhyUsController@store')->name('admin.why_us.store');
    Route::post('/why_us/delete/{id}/', 'Admin\WhyUsController@delete')->name('admin.why_us.delete');
    Route::get('/why_us/edit/{id}/', 'Admin\WhyUsController@edit')->name('admin.why_us.edit');
    Route::post('/why_us/update/{id}/', 'Admin\WhyUsController@update')->name('admin.why_us.update');
    Route::post('/why_us/why_uscontent/{id}/', 'Admin\WhyUsController@why_uscontent')->name('admin.why_uscontent.update');
    ...
    // Work Category Route
    Route::get('/work/work-category', 'Admin\WorkCategoryController@bcategory')->name('admin.workcategory');
    Route::get('/work/work-category/add', 'Admin\WorkCategoryController@add')->name('admin.workcategory.add');
    Route::post('/work/work-category/store', 'Admin\WorkCategoryController@store')->name('admin.workcategory.store');
    Route::post('/work/work-category/delete/{id}/', 'Admin\WorkCategoryController@delete')->name('admin.workcategory.delete');
    Route::get('/work/work-category/edit/{id}/', 'Admin\WorkCategoryController@edit')->name('admin.workcategory.edit');
    Route::post('/work/work-category/update/{id}/', 'Admin\WorkCategoryController@update')->name('admin.workcategory.update');

    // Work  Route
    Route::get('/work', 'Admin\WorkController@work')->name('admin.work');
    Route::get('/work/add', 'Admin\WorkController@add')->name('admin.work.add');
    Route::post('/work/store', 'Admin\WorkController@store')->name('admin.work.store');
    Route::post('/work/delete/{id}/', 'Admin\WorkController@delete')->name('admin.work.delete');
    ...
    Route::post('/work/blogcontent/{id}/', 'Admin\WorkController@blogcontent')->name('admin.blogcontent.update');
    Route::get('work/get/categoty/{id}', 'Admin\WorkController@blog_get_category')->name('admin.work.work_get_category');
