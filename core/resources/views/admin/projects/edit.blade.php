...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{ __('Project') }} </h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.project'). '?language=' . $currentLang->code }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.project.update',  $service->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label">{{ __('Project Name') }}<span class="text-danger">*</span></label>
