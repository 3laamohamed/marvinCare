            ...
            <div class="col-lg-12">
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title mt-1">{{ __('Edit Work Category') }}</h3>
                                <div class="card-tools">
                                    <a href="{{ route('admin.workcategory'). '?language=' . $currentLang->code }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.workcategory.update', $bcategory->id) }}" method="POST">
                                    @csrf
