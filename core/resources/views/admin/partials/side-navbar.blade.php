        ...
        @endif">
          ...
          @endif">
            ...
            @endif">
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.project'). '?language=' . $lang_code  }}" class="nav-link
            @if(request()->path() == 'admin/project') active
            @elseif(request()->path() == 'admin/project/add') active
            @elseif(request()->is('admin/project/edit/*')) active
            @endif">
                        <i class="nav-icon fas fa-briefcase"></i>
                        <p>
                            {{ __('Project') }}
                ...
                <li class="nav-item">
                    <a href="{{ route('admin.why_us'). '?language=' . $lang_code  }}" class="nav-link
            @if(request()->path() == 'admin/why_us') active
            @elseif(request()->path() == 'admin/why_us/add') active
            @elseif(request()->is('admin/why_us/edit/*')) active
            @endif">
                        <i class="nav-icon fas fa-briefcase"></i>
                        <p>
                            {{ __('Why Us') }}
            ...
            @endif">
              ...
              @endif">
                ...
                <li class="nav-item has-treeview
              @if(request()->path() == 'admin/work') menu-open
              @elseif(request()->path() == 'admin/work/work-category') menu-open
              @elseif(request()->path() == 'admin/work/work-category/add') menu-open
              @elseif(request()->path() == 'admin/work/add') menu-open
              @elseif(request()->path() == 'admin/archives') menu-open
              @elseif(request()->path() == 'admin/archive/edit') menu-open
              @elseif(request()->path() == 'admin/archive/add') menu-open
              @elseif(request()->is('admin/work/work-category/edit/*')) menu-open
              @elseif(request()->is('admin/work/edit/*')) menu-open
              @endif">
                    <a href="#" class="nav-link
                @if(request()->path() == 'admin/work') active
                @elseif(request()->path() == 'admin/work/work-category') active
                @elseif(request()->path() == 'admin/work/work-category/add') active
                @elseif(request()->path() == 'admin/work/add') active
                @elseif(request()->path() == 'admin/archives') active
                @elseif(request()->path() == 'admin/archive/edit') active
                @elseif(request()->path() == 'admin/archive/add') active
                @elseif(request()->is('admin/work/work-category/edit/*')) active
                @elseif(request()->is('admin/work/edit/*')) active
                @endif">
                        <i class="nav-icon fas fa-box-open"></i>
                        <p>
                            {{ __('Work') }}
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.workcategory'). '?language=' . $lang_code }}" class="nav-link
                  @if(request()->path() == 'admin/work/work-category') active
                  @elseif(request()->path() == 'admin/work/work-category/add') active
                  @elseif(request()->is('admin/work/work-category/edit/*')) active
                  @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('Work Categories') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.work'). '?language=' . $lang_code }}" class="nav-link
                  @if(request()->path() == 'admin/work') active
                  @elseif(request()->path() == 'admin/work/add') active
                  @elseif(request()->is('admin/work/edit/*')) active
                  @endif">
