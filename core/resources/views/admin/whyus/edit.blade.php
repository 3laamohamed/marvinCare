...
<div class="content-header">
    <div class="container-fluid">
        <div class="row">
        <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{ __('Why Us') }} </h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fas fa-home"></i>{{ __('Home') }}</a></li>
                <li class="breadcrumb-item">{{ __('Why Us') }}</li>
            </ol>
        </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary card-outline">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{ route('admin.why_us'). '?language=' . $currentLang->code }}" class="btn btn-primary btn-sm">
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('admin.why_us.update',  $service->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-2 control-label">{{ __('Why us') }}<span class="text-danger">*</span></label>
        
                                        <div class="col-sm-10">
                                            <input type="text" name="name" class="form-control"  placeholder="{{ __('Project Name') }}" value="{{ $service->name }}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                        <textarea name="disc" class="form-control summernote" rows="3" placeholder="{{ __('Description') }}">{{ $service->disc }}</textarea>
